...
function LandingPage() {
  ...
  return <div className="landing-page">
    ...
    <Reveal className="landing-editorial-section landing-how" id="how-it-works"><div className="landing-editorial-index">02 / HOW IT WORKS</div><div className="landing-editorial-copy"><h2>From drift signal<br />to <em>accountable action.</em></h2><p>Signals move through a calm, deterministic sequence: correlate the change, score the risk, recommend the response, then remember the outcome.</p></div><div className="landing-process"><div className="landing-process-step"><span>01</span><div className="landing-process-content"><div className="process-diagram process-diagram-correlate"><span className="process-node process-node-a"><Activity size={13} /></span><span className="process-node process-node-b"><CloudCog size={13} /></span><span className="process-node process-node-c"><GitBranch size={13} /></span><i className="process-signal-line" /></div><strong>Correlate</strong><p>Join AWS Config, CloudTrail, IaC, and deployment context.</p></div></div><div className="landing-process-line" /><div className="landing-process-step"><span>02</span><div className="landing-process-content"><div className="process-diagram process-diagram-explain"><span className="evidence-sheet evidence-sheet-back" /><span className="evidence-sheet evidence-sheet-mid" /><span className="evidence-sheet evidence-sheet-front"><CheckCircle2 size={14} /></span><span className="evidence-spark evidence-spark-one" /><span className="evidence-spark evidence-spark-two" /></div><strong>Explain</strong><p>Show the evidence and the historical matches behind the score.</p></div></div><div className="landing-process-line" /><div className="landing-process-step"><span>03</span><div className="landing-process-content"><div className="process-diagram process-diagram-decide"><span className="decision-root"><GitBranch size={14} /></span><span className="decision-branch decision-branch-a"><Check size={12} /></span><span className="decision-branch decision-branch-b"><AlertTriangle size={12} /></span><span className="decision-branch decision-branch-c"><Ban size={12} /></span><i className="decision-line decision-line-a" /><i className="decision-line decision-line-b" /><i className="decision-line decision-line-c" /></div><strong>Decide</strong><p>Approve, condition, or block with an exportable audit trail.</p></div></div></div><Link href="/console" className="landing-primary-cta landing-process-cta">Open the console <ArrowUpRight size={17} /></Link></Reveal>
